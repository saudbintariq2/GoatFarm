...
public interface IFinanceService
{
    ...
    Task<RecurringCostViewModel?> UpdateRecurringCostAsync(int id, CreateRecurringCostViewModel model, CancellationToken cancellationToken = default);
    ...
    Task<bool> DeleteRecurringCostAsync(int id, CancellationToken cancellationToken = default);
    decimal GetLivestockValue();
    decimal GetAssetsValue();
    decimal GetCapital();
    decimal GetRecurringMonthlyTotal();
}
